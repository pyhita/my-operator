...
// +kubebuilder:rbac:groups=mygroup.pyhita.com,resources=configmapsyncs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=mygroup.pyhita.com,resources=configmapsyncs/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=mygroup.pyhita.com,resources=configmapsyncs/finalizers,verbs=update
...
func (r *ConfigMapSyncReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	configMapSync := &mygroupv1.ConfigMapSync{}
